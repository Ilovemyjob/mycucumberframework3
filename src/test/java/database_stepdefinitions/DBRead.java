...
public class DBRead {
    //kaolapalace.com/admin/HotelAdmin=it is used for Data base testing
        ...
        public void user_gets_the_table(String string, String string2) throws SQLException {
           ...
           // resultSet=statement.executeQuery("SELECT Name FROM dbo.tHOTEL");//hard
            resultSet=statement.executeQuery("SELECT "+string+" FROM dbo.t"+string2);//dynamic
        }
        ...
        public void user_reads_all_rows_in_the_column(String string) throws SQLException {
          ...
          // Object object1 =resultSet.getObject("Name"); hard code
            Object object1=resultSet.getObject(string);

            System.out.println(object1);//3. stundakimni cilarir
            resultSet.next();
            System.out.println("-------------------");
            System.out.println(resultSet.getObject(string));//4.stundakini cikarir
            resultSet.next();
            System.out.println("-------------------");
            System.out.println(resultSet.getObject(string));
            System.out.println("-------------------");
            while (resultSet.next()){//itirator=get all column list
...
//            }
        ...
        public void user_gets_the_value_in_row_in_column_and_verifies_the_value_is(Integer int1, String string, String string2) throws SQLException {
            ...
            //ucunua yazmak yerine alttakini kullandik
...
//        System.out.println(string2);
            ...
            Assert.assertEquals(string2,obj.toString());//making the assertion-expected,actual
        }
    }